...
# ==== CONFIG ====
ROWS, COLS = 3, 3
MODEL_PATH = "D:/University/OneDrive - UCB-O365/Mech2/Final_Project/runs/detect/train13/weights/best.pt"
...
class BoardDetector:
    ...
    def show_detection_window(self):
        ...
        grid_top_left = (100, 100)      # Top-left corner (x, y)
        grid_bottom_right = (400, 400)  # Bottom-right corner (x, y)
        ...
        try:
            while True:
                ...
                for i in range(1, COLS):
                    x = grid_top_left[0] + i * cell_width
                    y1, y2 = grid_top_left[1], grid_bottom_right[1]
                    cv2.line(display_image, (x, y1), (x, y2), (255, 0, 0), 4)
                    # cv2.line(display_image, (i * self.cell_width, 0),
                    #          (i * self.cell_width, display_image.shape[0]), (255, 0, 0), 2)
                for j in range(1, ROWS):
                    y = grid_top_left[1] + j * cell_height
                    x1, x2 = grid_top_left[0], grid_bottom_right[0]
                    cv2.line(display_image, (x1, y), (x2, y), (255, 0, 0), 4)
